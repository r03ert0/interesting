...
* http://www.lix.polytechnique.fr/~maks/papers/S19_OptPreserve_camera.pdf. Spectral Coarsening of Geometric Operators
* https://nmwsharp.com/media/cea_tutorial.pdf. Céa’s Method for PDE-constrained shape optimization
...
* https://github.com/rafalab/ds4stats. Data Science for Statisticians Workshop
* https://petterhol.me/2019/04/15/firsts-in-network-science/amp/. Firsts in network science
* https://distill.pub/2019/activation-atlas/. Exploring Neural Networks with Activation Atlases
* https://www.meltingasphalt.com/interactive/going-critical/. Going Critical: Interactive exploration of infection models
* https://github.com/matterport/Mask_RCNN/tree/master/samples/balloon. This is an example showing the use of Mask RCNN in a real application. We train the model to detect balloons only, and then we use the generated masks to keep balloons in color while changing the rest of the image to grayscale.
...
* https://umap-learn.readthedocs.io. UMAP: Uniform Manifold Approximation and Projection for Dimension Reduction
* https://github.com/sctyner/memer. A tidyverse compatible package for creating memes in R using the magick package. https://sctyner.github.io/memer/
* https://github.com/thibauts/node-google-search-scraper. Google search scraper with captcha solving support
...
* https://mirkokiefer.com/cmake-by-example-f95eb47d45b1. CMake by Example
...
* https://videocast.nih.gov/Summary.asp?File=27384&bhcp=1. In scientific method we don’t just trust: or why replication has more value than discovery
* http://www.cocites.com/. CoCites is a novel search method for finding scientific studies. The method uses citations rather than keywords to search the literature.
* https://www.reddit.com/r/MachineLearning/comments/bnypj2/p_simple_tensorflow_implementation_of_spheregan/. Simple Tensorflow implementation of SphereGAN (CVPR 2019 Oral)
...
* https://www.biorxiv.org/content/10.1101/588020v1. Recovery of trait heritability from whole genome sequence data
* https://www.sciencedirect.com/science/article/pii/S1878929318301245. Sex differences in functional connectivity during fetal brain development
* https://www.genetics.org/content/211/4/1131. Complex Trait Prediction from Genome Data: Contrasting EBV in Livestock to PRS in Humans
* https://www.sciencedirect.com/science/article/pii/S1053811919303179. Determinants of structural segregation and patterning in the human cortex
* https://www.biorxiv.org/content/10.1101/413211v2. Modularity, criticality, and evolvability of a developmental gene regulatory network
* http://embor.embopress.org/content/16/9/1064.full. Everything flows: A process perspective on life
* https://www.spectrumnews.org/opinion/viewpoint/families-need-guidance-buying-communication-app-autism. Families need guidance before buying a communication app for autism
* https://www.tandfonline.com/doi/abs/10.1080/01677063.2017.1404058. Gene networks associated with non-syndromic intellectual disability

### Musical things
* http://escavacoes-sonoras.blogspot.com/2019/04/anderson-paak-ventura-2019.html. Escavações sonoras (blog)

### Picture things
* https://www.behance.net/gallery/80309893/Cecropia. A project in which we have designed several insects mutated by geometric shapes and elements as fabrics, metallic and organic structures changing their morphology.
